...
from scene.global_vars import AI_FUNCTION_TYPES_OPTIONS, AI_FUNCTION_OPTIONS, ai_function_one_index, ai_function_one_type_index, ai_function_two_index, ai_function_two_type_index, handle_ai_one_function_index_change, handle_ai_one_function_type_index_change, handle_ai_two_function_index_change, handle_ai_two_function_type_index_change
