...
| **Asset**                                                | **Meaning**           |
| -------------------------------------------------------- | --------------------- |
| ![character](./assets/character.png)                     | Player (Human)        |
| ![minimax algorithm](./assets/min-max-profile.png)       | Minimax algorithm     |
| ![alpha-beta algorithm](./assets/alpha-beta-profile.png) | Alpha-Beta algorithm  |
| ![offensive heuristic 1](./assets/sword.png)             | Offensive heuristic 1 |
| ![defensive heuristic 1](./assets/shield.png)            | Defensive heuristic 1 |
| ![offensive heuristic 2](./assets/dice_sword.png)        | Offensive heuristic 2 |
